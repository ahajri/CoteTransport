...
var server = app.listen(8585, function() {
	...
	// MongoDB
	mongoclient.connect('mongodb://localhost:27017/APPDB',{native_parser:true},function(err, db) {
...
app.post('/modifyUserAsync/', supportCrossOriginScript, function(req, res,next) {
